...
* $Id: handlecommon.c,v 2.86 1998/04/20 18:01:03 Holt Exp $
* $Log: handlecommon.c,v $
*Revision 2.86  1998/04/20  18:01:03  Holt
*updated for ToasterFlyer sales promotion
*
*Revision 2.85  1997/04/18  17:08:42  Holt
...
char
	...
	AboutMsg2[] = " ",
	AboutMsg3[] = "   Copyright \xA9 1994, 1998 NewTek, Inc.",
	AboutMsg4[] = " ",
	AboutMsg5[] = "   Written by...",
	AboutMsg6[] = "       David Holt",
	AboutMsg7[] = "       Arnie Cachelin",
	AboutMsg8[] = "       Marty Flickinger",
	AboutMsg9[] = "       Pat Brouillette",
	AboutMsg10[] ="   Based on demo code by Steve Hartford",
