...
*
* $Id: hard.c,v 1.5 1995/11/21 11:59:02 Flick Exp $
*
* $Log: hard.c,v $
...
static const ULONG VCOindexTable[] = {
	...
	DBUG(print(DB_GEN,"Frequency desired (%b) = %l\n",clock,freq);)
...
//								err,p,q,mux,pre);)
	...
	if (besterr == INT_MAX)
	{
		DBUG(print(DB_INTERN,"Illegal clock value\n");)
...
//	DBUG(print(DB_INTERN,"Best: err=%l P'=%l Q'=%l M=%l I=%l S=%l\n",
...
void SetClockGen(UBYTE chan, ULONG val)
{
	...
	DBUG(print(DB_GEN,"Clock gen chan %b, value %l\n",chan,val);)
