...
*
* $Id: vid.c,v 1.16 1997/02/06 18:17:41 Holt Exp $
*
* $Log: vid.c,v $
...
void SpeedUpChips(BOOL flag)
{
	...
	if (flag)
	{
		DBUG(print(DB_ALWAYS,"Flag is true switching to fastmode.\n ");)
		if (VideoMode == VM_RECORD)
		{
			Mspd = 84000000;	//4.1 values
			Pspd = 49000000;
//			Mspd = 87000000;  //86 seemed to work
//			Pspd = 52000000;	//51 seemed to work
		}
		else
		{
			Mspd = 85000000;  //4.1 values
			Pspd = 50000000;
//			Mspd = 87000000;	//86 seemed to work	
//			Pspd = 53000000;	//52 seemed to work
	...
	{
		VidGrade = GRADE_STD;
		DBUG(print(DB_ALWAYS,"Flag is false switching to slow mode.\n");)
