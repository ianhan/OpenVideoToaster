...
CHECKMASK:	MACRO	;(destroys d2/d3/d4/a0)  (args d0=x d1=y a3=bm_planes)
	CHECKSETUP
	move.l	(6*4)(a3),d3	;7th (mask) bitplane
...
;	move.w	#752/3,PixelsPerRow	;TESTDEH120695
...
1$:
	...
	ASL.L	#1,PixelsPerRow		;ADDED DEH120695
...
getoagain:
	...
	move.l	s_red(a6),d2	;8 bits per col-or, again
